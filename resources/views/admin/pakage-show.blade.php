...
@section('content')
<a href="{{route('pakage.add')}}" class="btn btn-primary">Add Pakage</a>
<br>
<div class="row">
	 @foreach($pakage as $pakage)
          ...
          <div style="margin: 15px;" class="card text-center">
              ...
              <div class="card-footer text-muted">
                  <a style="float: right;" href="{{route('pakage.edit',$pakage->id)}}" class="btn btn-success">Edit</a>&nbsp;
                  <form class="form-inline" method="post" action="{{route('pakage.delete',$pakage->id)}}">
                  @csrf
                  {{ method_field("DELETE") }}
